...
vanilla_items = [
    ...
    # Biomes
    needed("Ocean Biomes"),
    needed("Plains Biomes"),
    needed("Savanna Biomes"),
    needed("Forest Biomes"),
    needed("Jungle Biomes"),
    needed("Wetland Biomes"),
    needed("Mountain Biomes"),
    needed("Highland Biomes"),
    needed("Arid Biomes"),
    needed("Underground Biomes"),
    needed("Nether Biomes"),
    needed("End Biomes"),
    # USEFUL ###########################################################################################################
    # Materials
    useful("4 Emeralds"),
